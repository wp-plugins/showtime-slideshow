...
class aframework
{
	...
	function RegisterAdministrationPage( $parentMenu, $minimumAccessLevel, $adminMenuTitle, $adminMenuPageTitle, $adminMenuPageSlug ) 
	{
		...
		$tempTitle = "<style type='text/css'>em {border:1px solid #ccc; background:#ddd; -border-radius:10px; -webkit-border-radius:10px; -moz-border-radius:10px; padding:0px 7px;color:#fff;text-shadow:0 0 4px #000; display:block; margin:1px 0;width:155px}</style>";
		/*
