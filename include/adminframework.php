...
class adminframework
{
	...
	var $_pluginTitle = "ShowTime Slideshow";
	var $_pluginVersion = "0.1";
	var $_pluginSubfolderName = "showtime";
	var $_pluginFileName = "";
	var $_pluginHome = "";
	var $_pluginComments = "";
	var $_pluginRate = "";
...
*/
	...
	function _AddAdministrationAjax() {
		...
		//wp_enqueue_script( 'org_myplugins_mpf_tooltip', plugins_url($path = $this->_pluginSubfolderName . '/include/js/jquery.tooltip.min.js') );
		//wp_enqueue_style( 'org_myplugins_mpf', plugins_url($path = $this->_pluginSubfolderName . '/include/style.css') );
	}
	...
	function AddHoverFunctionality() {
		echo '<script type="text/javascript" src="' . plugins_url($path = $this->_pluginSubfolderName . '/include/js/jquery.tooltip.min.js') . '"></script>';
