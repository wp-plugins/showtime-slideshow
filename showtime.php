...
Description:Display images attached to a post/page as animated slideshow. Choose among smooth transition effects. Can also be set to use Flickr or Picasa RSS feeds. ShowTime requires Adobe Flash player 10 or higher.
Version: 1.5
...
class st_options extends aframework {
	...
	function _pluginDescription() {
		...
		_e( '
		<p>To use individual settings, use the following syntax: <code>[st parameter=value]</code>. <p>Example:</p><code>[st transition=flip autoplay=on]</code></p><br/><br/>
            ...
            <table class="form-table" rowpadding="40">
                <tr>
                  ...
                  <td>
                  	...
                  	<p>
                  	<label for="st_width"><? _e( 'Width (pixels) <em>width</em>', TXTDOMAIN ); ?></label>
                  	<?php $this->DisplayPluginOption( 'st_width' ); ?>
                  	</p>
                  	
					<p>
                  	<label for="st_height"><? _e( 'Height (pixels) <em>height</em>', TXTDOMAIN ); ?></label>
                  ...
                  <td>
					...
					<p>
					<label for="st_rotatetime"><? _e( 'Rotationtime (seconds) <em>rotationtime</em>', TXTDOMAIN ); ?></label>
					<?php $this->DisplayPluginOption( 'st_rotatetime' ); ?><br/>
					</p>
					
					<p>
					<label for="st_transitiontime"><? _e( 'Transitiontime (seconds) <em>transitiontime</em>', TXTDOMAIN ); ?></label>
                ...
                <tr>
                  ...
                  <td valign="top">
                    ...
                    <p><label for="st_transition"><? _e( 'Transition Type  <em>transition</em>', TXTDOMAIN ); ?></label>
					<?php $this->DisplayPluginOption( 'st_transition' ); ?></p>

				    <p><label for="st_ease"><? _e( 'Transition Easing <em>transitionease</em>', TXTDOMAIN ); ?></label>
				  ...
				  <td valign="top">
                    ...
                    <p><?php $this->DisplayPluginOption( 'st_autoplay' ); ?><label for="st_autoplay"><? _e( 'Start automatically  <em>autoplay</em>', TXTDOMAIN ); ?></label></p>		  
                    <p><?php $this->DisplayPluginOption( 'st_shuffle' ); ?><label for="st_shuffle"><? _e( 'Shuffle Images  <em>shuffle</em>', TXTDOMAIN ); ?></label></p>
					<p><?php $this->DisplayPluginOption( 'st_reverse' ); ?><label for="st_reverse"><? _e( 'Reverse Order  <em>reverse</em>', TXTDOMAIN ); ?></p> 					
                ...
                <tr>
                  ...
                  <td valign="top">
                    <p><?php $this->DisplayPluginOption( 'st_showcontrols' ); ?><label for="st_showcontrols"><? _e( 'Display Cursor Controls <em>showcontrols</em>', TXTDOMAIN ); ?></label></p>
                    
                    <p><?php $this->DisplayPluginOption( 'st_fullscreen' ); ?><label for="st_fullscreen"><? _e( 'Enable Fullscreen <em>fullscreen</em>', TXTDOMAIN ); ?></label></p>
                    
                    <p><?php $this->DisplayPluginOption( 'st_showtext' ); ?><label for="st_showtext"><? _e( 'Display Title  <em>showtext</em>', TXTDOMAIN ); ?></label></p>
                    <p><?php $this->DisplayPluginOption( 'st_showalt' ); ?><label for="st_showalt"><? _e( 'Display Caption <em>showalt</em>', TXTDOMAIN ); ?></label></p>

                 <p><label for="st_bgcolor"><? _e( 'Background Color  <em>bgcolor</em>', TXTDOMAIN ); ?></label>
                 ...
                 <p><label for="st_quality"><? _e( 'Display Quality <em>quality</em>', TXTDOMAIN ); ?></label>
				 <?php $this->DisplayPluginOption( 'st_quality' ); ?></p>

                 <p><label for="st_wmode"><? _e( 'Window Mode <em>wmode</em>', TXTDOMAIN ); ?></label>
				 <?php $this->DisplayPluginOption( 'st_wmode' ); ?></p>
                  ...
                  <td valign="top">
                    <p><label for="st_scalemode"><? _e( 'Scale Mode <em>scale</em>', TXTDOMAIN ); ?></label>
					<?php $this->DisplayPluginOption( 'st_scalemode' ); ?></p>
					
                    <p><label for="st_imgsize"><? _e( 'Source Image (Window) <em>source</em>', TXTDOMAIN ); ?></label>
					<?php $this->DisplayPluginOption( 'st_imgsize' ); ?></p>
					
                    <p><label for="st_imgfullsize"><? _e( 'Source Image (Fullscreen) <em>sourcehd</em>', TXTDOMAIN ); ?></label>
