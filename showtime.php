...
class st_options extends aframework {
	...
	function _pluginInfo() {
		_e( '<p>The showTime gallery plugin is free for personal and commercial use. If you like the plugin please consider a small <a href="http://youtag.lu/showtime-wp-plugin/" target="_blank">donation</a></p>', TXTDOMAIN );
...
$stOptions->Initialize(	'ShowTime Gallery Slideshow',
								'0.7',
								'showtime-slideshow',
								'showtime',
...
function showtime_plugin( $plugins ) {
	$plugins['showtime'] = plugins_url($path = $stOptions->_pluginSubfolderName.'/showtime/tinymce3/editor_plugin.js');
	return $plugins;
}
