            ...
            <table class="form-table" rowpadding="40">
                ...
                <tr>
                  ...
                  <td valign="top">
                    ...
                    <p><?php $this->DisplayPluginOption( 'st_showtext' ); ?><label for="st_showtext"><? _e( 'Display Title', TXTDOMAIN ); ?></label></p>
                    <p><?php $this->DisplayPluginOption( 'st_showalt' ); ?><label for="st_showalt"><? _e( 'Display <Alt> Description', TXTDOMAIN ); ?></label></p>
                 ...
                 <p><label for="st_wmode"><? _e( 'Window Mode [experimental]', TXTDOMAIN ); ?></label><br/>
				 <?php $this->DisplayPluginOption( 'st_wmode' ); ?></p>
                  ...
                  <td valign="top">
                    <p><label for="st_scalemode"><? _e( 'Scale Mode', TXTDOMAIN ); ?></label><br/>
