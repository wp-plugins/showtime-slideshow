...
Tags: wordpress, showtime, slideshow, gallery, animation, ken, burns, adobe, flash, images, photo, photos, picture, pictures, plugin, special, FX, animation, photo, show, presentation
...
* 
* Transition: flip (horizontal & vertical)
...
3. Search for Showtime Slideshow and install
4. Activate
...
1. ShowTime Settings. Set default options for all slideshows.

2. Example of a slideshow on a website using "shortcode" options to override default settings.
