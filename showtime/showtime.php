...
class st_options extends adminframework {
	...
	function _pluginDescription() {
		...
		_e( '<p><a href="http://youtag.lu/showtime-samples/" target="_blank">Click here</a> to view usage examples.</p>', TXTDOMAIN );
	}
	...
	function _pluginInfo() {
		...
		_e( '<p>If you need a customized version of <i>showTime</i>, please drop a note on my <a href="http://youtag.lu/contact/" target="_blank">contact page</a>.</p>', TXTDOMAIN );
	}
...
function showtime_plugin( $plugins ) {
	$plugins['showtime'] = plugins_url('/showtime/tinymce3/editor_plugin.js');
	return $plugins;
}
