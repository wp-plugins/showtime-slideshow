	...
	<p><a href="http://adobe.com/go/getflashplayer" target="_blank">Download the free Flash Player now!</a></p></div>';
		...
		if ( $slide )
			...
			<script type='text/javascript'>
				...
				swfobject.embedSWF ('" . plugins_url($path = $stOptions->_pluginSubfolderName . '/showtime/st15.swf') . "', '" . $classid . "', '$width', '$height', '10.0.0', '$alternative', flashvars, params, attributes);
			</script>
